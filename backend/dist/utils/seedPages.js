...
const seedPages = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        for (const pageData of DEFAULT_PAGES) {
            const existing = yield Page_1.default.findOne({ slug: pageData.slug });
            if (!existing) {
                const newPage = new Page_1.default(pageData);
                yield newPage.save();
